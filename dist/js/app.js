var card_data = [ {
    slug: "blizzard",
    social: "My heart's reserved for you",
    artist: "Emma Patti Harris",
    twitpic: "pic.twitter.com/ywM0xgh4Oe"
}, {
    slug: "divine",
    social: "You're simply Divine",
    artist: "Kalani Gordon",
    twitpic: "pic.twitter.com/Gf6sq7F8xc"
}, {
    slug: "wheelie",
    social: "I wheelie love you",
    artist: "Kalani Gordon",
    twitpic: "pic.twitter.com/FEMqo3Ouib"
}, {
    slug: "lovebirds",
    social: "Baltimore is for love birds",
    artist: "Emma Patti Harris",
    twitpic: "pic.twitter.com/X76teqcC7F"
}, {
    slug: "triplecrown",
    social: "You're the jewel in my Triple Crown",
    artist: "Emma Patti Harris",
    twitpic: "pic.twitter.com/hdQgS0t1JI"
}, {
    slug: "oriolescrush",
    social: "You are my no. 1 crush",
    artist: "Greg Kohn ",
    twitpic: "pic.twitter.com/u5eBK4nec4"
}, {
    slug: "flamingos",
    social: "You've got me head over heels",
    artist: "Kalani Gordon",
    twitpic: "pic.twitter.com/aCVN9BdF3V"
}, {
    slug: "bae",
    social: "Be my Chesapeake Bae",
    artist: "Emma Patti Harris",
    twitpic: "pic.twitter.com/1hcYLXcza9"
}, {
    slug: "hon",
    social: "Bee mine",
    artist: "Kalani Gordon",
    twitpic: "pic.twitter.com/1RDwXrYQK0"
}, {
    slug: "utzboh",
    social: "I'm so glad I swiped right ;)",
    artist: "Emma Patti Harris",
    twitpic: "pic.twitter.com/7RMEOcWnpz"
}, {
    slug: "steer",
    social: "Nothing can steer me away from you",
    artist: "Greg Kohn",
    twitpic: "pic.twitter.com/5Vq7f4aKxq"
}, {
    slug: "cake",
    social: "You're my perfect 10!",
    artist: "Dana Amihere",
    twitpic: "pic.twitter.com/gciEIkWgEu"
}, {
    slug: "hungry",
    social: "I #stayhungry for your love <3",
    artist: "Emma Patti Harris",
    twitpic: "pic.twitter.com/3mOta9x4Aq"
}, {
    slug: "fishers",
    social: "You make my heart pop",
    artist: "Emma Patti Harris",
    twitpic: "pic.twitter.com/woTyRiqKAJ"
}, {
    slug: "marc",
    social: "You've left a Marc on my heart",
    artist: "Patrick Maynard",
    twitpic: "pic.twitter.com/zGrJXOuYmD"
}, {
    slug: "buck",
    social: "Buckle up for love",
    artist: "Michael Gold ",
    twitpic: "pic.twitter.com/oSyIKE5Z0G"
}, {
    slug: "oldbay",
    social: "Thanks for keepign things spicy!",
    artist: "Dana Amihere",
    twitpic: "pic.twitter.com/LVNXn7mkRl"
}, {
    slug: "tucker",
    social: "I like it when you show a little leg",
    artist: "Kalani Gordon",
    twitpic: "pic.twitter.com/2CYxUaL8aN"
}, {
    slug: "domino",
    social: "You're sweet as...Domino Sugars",
    artist: "Stokely Baksh",
    twitpic: "pic.twitter.com/OaSjDq0NNY"
}, {
    slug: "crab",
    social: "You're a good catch",
    artist: "Adam Marton",
    twitpic: "pic.twitter.com/bQD1VVTBFZ"
}, {
    slug: "poe",
    social: "I think we have romantic Poe-tential",
    artist: "Stokely Baksh",
    twitpic: "pic.twitter.com/tLtPL7dxYz"
}, {
    slug: "boh",
    social: "I'll give you x's & o's, ribbons & bohs",
    artist: "Adam Marton",
    twitpic: "pic.twitter.com/ShkCVEFmty"
}, {
    slug: "srb",
    social: "I think you're smashing!",
    artist: "Matt Bracken",
    twitpic: "pic.twitter.com/DDNonGERzx"
}, {
    slug: "surveillance",
    social: "From: your secret admirer",
    artist: "Kalani Gordon",
    twitpic: "pic.twitter.com/kEfnvb3Uoz"
}, {
    slug: "sunk",
    social: "I'm sunk without you",
    artist: "Kalani Gordon",
    twitpic: "pic.twitter.com/oAUhFE3GeW"
}, {
    slug: "endless-summer",
    social: "Our love is an endless summer",
    artist: "Kalani Gordon",
    twitpic: "pic.twitter.com/k1Z7G38yYG"
}, {
    slug: "hayden",
...
var app = {
    ...
    facebook_item: function(slug) {
        ...
        var picture = "http://data.baltimoresun.com/valentines/images/valentines/300x300/" + slug + ".jpg";
        var title = "Baltimore Valentines";
        var description = chosen[0].social;
    ...
    pin_item: function(slug) {
        ...
        var url = "http://data.baltimoresun.com/valentines%23" + slug;
        var picture = "http://data.baltimoresun.com/valentines/images/valentines/800x800/" + slug + ".jpg";
        var description = chosen[0].social + " | From Charm City with <3: Baltimore-themed Valentines";
        description = description.replace(/#/g, "%23");
        description = description.replace(/&/g, "%26");
        var pinterest_url = "https://www.pinterest.com/pin/create/button/?url=" + url + "&media=" + picture + "&description=" + description;
        window.open(pinterest_url, "mywin", "left=200,top=200,width=500,height=300,toolbar=1,resizable=0");
        return false;
    },
    ...
    share: function() {
        ...
        $(".icon-facebook").on("click", function() {
            var picture = "http://data.baltimoresun.com/valentines/images/social.jpg";
            var title = "Baltimore Sun Valentines";
            var description = "From Charm City with <3: Baltimore-themed Valentines";
            var url = "http://data.baltimoresun.com/valentines";
